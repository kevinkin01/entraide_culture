...
class ArticleManager
{
    ...
    public function presentation(int $id){
        $sql = "SELECT * FROM `article` WHERE `categoryidcategory` = 1";
        $request = $this->db->prepare($sql);
        $request->bindValue(1,$id,PDO::PARAM_INT);
        $request->execute();
        if($request->rowCount()){
    ...
    public function asbl(int $id){
        $sql = "SELECT * FROM `article` WHERE `categoryidcategory` = 2";
        $request = $this->db->prepare($sql);
        $request->bindValue(1,$id,PDO::PARAM_INT);
        $request->execute();
        if($request->rowCount()){
    ...
    public function entraide(int $id){
        $sql = "SELECT * FROM `article` WHERE `categoryidcategory` = 3";
        $request = $this->db->prepare($sql);
        $request->bindValue(1,$id,PDO::PARAM_INT);
        $request->execute();
        if($request->rowCount()){
    ...
    public function culture(int $id){
        $sql = "SELECT * FROM `article` WHERE `categoryidcategory` = 4";
        $request = $this->db->prepare($sql);
        $request->bindValue(1,$id,PDO::PARAM_INT);
        $request->execute();
        if($request->rowCount()){
    ...
    public function ancrage(int $id){
        $sql = "SELECT * FROM `article` WHERE `categoryidcategory` = 5";
        $request = $this->db->prepare($sql);
        $request->bindValue(1,$id,PDO::PARAM_INT);
        $request->execute();
        if($request->rowCount()){
